...
""" 
Floyd Warshall solves all pair shortest path problem. It is an algorithm to find shortest distance path between all pairs of vertices in weighted graph. It works for both
 directed and undirected graph but it does not work for negetive cycles (where sum of edges in cycle is negetive)
